...
if (run_sca == 1){
  ...
  # Save SCAs
  write.csv(sca_gui[[bootstraps+1]], file="../data/objects/3_1_GUI_SCA.csv")
  write.csv(sca_psid[[bootstraps+1]], file="../data/objects/3_2_PSID_SCA.csv")
  write.csv(sca_mcs[[bootstraps+1]], file="../data/objects/3_3_MCS_SCA.csv")
  
  write_rds(sca_gui, "./data/objects/3_1_GUI_SCA_SCAboot.rds")
  write_rds(sca_psid, "./data/objects/3_2_PSID_SCA_SCAboot.rds")
  write_rds(sca_mcs, "./data/objects/3_3_MCS_SCA_SCAboot.rds")
  ...
  sca_gui <- read_rds("../data/objects/3_1_GUI_SCAboot.rds")
  sca_psid <- read_rds("../data/objects/3_2_PSID_SCAboot.rds")
  sca_mcs <- read_rds("../data/objects/3_3_MCS_SCAboot.rds")
...
if (run_null == 1){
  ...
  # Save null models
  write_rds(y_null_gui, "../data/objects/3_1_GUI_ynull.rds")
  write_rds(y_null_psid, "../data/objects/3_2_PSID_ynull.rds")
  write_rds(y_null_mcs, "../data/objects/3_3_MCS_ynull.rds")
  
} else {
  
  # Read null models
  y_null_gui <- read_rds("../data/objects/3_1_GUI_ynull.rds")
  y_null_psid <- read_rds("../data/objects/3_2_PSID_ynull.rds")
  y_null_mcs <- read_rds("../data/objects/3_3_MCS_ynull.rds")
...
for (b in 1:(bootstraps+1)) {
  ...
  write_rds(bootstraps_gui, "../data/objects/3_1_GUI_boot.rds")
  write_rds(bootstraps_psid, "../data/objects/3_2_PSID_boot.rds")
  write_rds(bootstraps_mcs, "../data/objects/3_3_MCS_boot.rds")
